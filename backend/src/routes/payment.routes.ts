...
import { createRazorpayOrder, getMonthWiseBilling, getPaymentHistorybyPatientHandler, verifyRazorpayPayment } from '../controllers/payment.controller';
...
paymentRoutes.get('/history', authorize(UserRole.PATIENT), getPaymentHistorybyPatientHandler);
