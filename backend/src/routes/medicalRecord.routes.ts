...
import { fetchPatientMedicalRecordController, fetchPatientMedicalRecordControllerById, getPatientMedicineCourse } from '../controllers/medicalRecord.controller';
...
medicalRecordRoutes.get('/patient-medicines',authorize(UserRole.PATIENT),getPatientMedicineCourse);
