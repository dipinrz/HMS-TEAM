...
import { addMedicineAPI, getMedicineAPI } from '../../services/medicineAPI';
...
export const AllMedicines: React.FC = () => {
    ...
    const handleSubmit = async (data: Omit<MedicineFormData, 'cost'> & { cost: number }) => {
    try {
                                    ...
                                    filteredMedicines.map((medicine, index) => (
                                        ...
                                        >
                                            ...
                                            <TableCell>
                                                <Typography
                                                    sx={{
                                                        color: new Date(medicine.expiry_date) < new Date() 
                                                            ? "#dc2626" 
                                                            : "inherit",
                                                        fontWeight: new Date(medicine.expiry_date) < new Date() 
                                                            ? 600 
                                                            : "inherit",
                                                    }}
                                                >
